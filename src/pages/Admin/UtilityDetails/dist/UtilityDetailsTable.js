...
var API_URL = "https://masteradmin.fibepe.com/api/Master/UtilityDetail";
...
// --- MAIN COMPONENT ---
var UtilityDetailTable = function () {
    ...
    react_1.useEffect(function () {
        var fetchRechargeData = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        data = _b.sent();
                        if (data.IsSuccess && ((_a = data.payLoad) === null || _a === void 0 ? void 0 : _a.AllUtilityDetail)) {
    ...
    var totalAmount = react_1.useMemo(function () {
    ...
    if (isLoading) {
        return (react_1["default"].createElement("div", { className: "text-center p-5" },
            react_1["default"].createElement("h5", null, "Loading Utility Details..."),
        ...
        react_1["default"].createElement("div", { className: "table-responsive table-card mt-3 mb-1" },
            react_1["default"].createElement("table", { className: "table align-middle table-nowrap text-center", id: "rechargeTable" },
                ...
                react_1["default"].createElement("tbody", { className: "list form-check-all" }, paginatedRecords.length > 0 ? (paginatedRecords.map(function (record) { return (react_1["default"].createElement("tr", { key: record.LedgerId },
                    ...
                    react_1["default"].createElement("td", null, record.ConsumerNumber),
                    react_1["default"].createElement("td", null, record.CategoryName),
                    react_1["default"].createElement("td", null, record.Amount),
...
exports["default"] = UtilityDetailTable;
